...
STATMT_XZ_FILENAME=${DATA_FOLDER}/statmt_2017_17_train_target_sentences.txt.xz
STATMT_EXTRACTED_FILENAME=${DATA_FOLDER}/statmt_2017_17.txt
if [ ! -f ${STATMT_XZ_FILENAME} ]; then
	curl "http://web-language-models.s3-website-us-east-1.amazonaws.com/ngrams/sk/raw/sk.sk.2017_17.raw.xz" -o ${STATMT_XZ_FILENAME}
fi
...
cat ${STATMT_SENTENCES_FILENAME} | python3 create_dataset.py ${num_lines} ${DATA_FOLDER} \
    ...
    --max_rep_train ${MAX_REP_TRAIN_SENTENCES}
...
if [ ${DO_APPEND} = "y" ]; then
    ...
    echo "train_targets target_train.txt" >> ${DATA_FOLDER}/statmt_configuration.txt
else
    # create experiment configuration file
