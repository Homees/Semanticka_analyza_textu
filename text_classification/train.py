...
if __name__ == '__main__':
    ...
    plt.ylabel('WCSS')
    fig.savefig('/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/elbow_2k.png')
    plt.show()
    ...
    pickle.dump(kmeans, open("/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/kmeans_model_12c_14k.pickle", "wb"))
    pickle.dump(vectorizer, open("/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/tfidf_model_12c_14k.pickle", "wb"))
    ...
    fig.savefig('/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/clusters_12c_14k.png', dpi=400)
    plt.show()
