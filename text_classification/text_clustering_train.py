...
if __name__ == '__main__':
    path = "/u00/au973065/git_repo/oprava_diakritiky/diacritics_restoration/test_texts/all_diacritized_emails.txt"
    ...
    #plt.ylabel('WCSS')
    #fig.savefig('/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/elbow.png')
    #plt.show()
    ...
    labels_color_map = {
        ...
        5: '#ccc0ba', 6: '#47fff9', 7: '#f6f900', 8: '#00f91d', 9: '#da8c49',
        10: '#b2c425', 11: '#aeed66', 12: '#3f7fe0', 13: '#bc4fff', 14: '#ff922b',
        15: '#ff1919'
    }
    
    pickle.dump(kmeans, open("/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/kmeans_model.pickle", "wb"))
    pickle.dump(vectorizer, open("/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/save/tfidf_model.pickle", "wb"))
    ...
    plt.hold(True)
    plt.scatter(centers2D[:,0], centers2D[:,1], marker='^', s=200, c='r')
        
    plt.title('Cluster neibours')
    plt.xlabel('X value')
    plt.ylabel('Y value')
    fig.savefig('/u00/au973065/git_repo/Semanticka_analyza_textu/text_classification/data/clusters.png')
    plt.show()
